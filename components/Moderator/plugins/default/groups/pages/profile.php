...
<div class="ossn-group-profile">
    ...
    <div class="col-md-11">
        ...
        <?php if ($params['group']->owner_guid == ossn_loggedin_user()->guid || ossn_isAdminLoggedin() || user_canModerate()) { ?>
               ...
               <?php if ($params['group']->owner_guid == ossn_loggedin_user()->guid || ossn_isAdminLoggedin() || user_canModerate()) { ?>
                    <div class="ossn-group-cover-button">
						...
						echo ossn_plugin_view('output/url', array(
							'text' => ossn_print('delete:cover'),
							'href' => ossn_site_url("action/group/cover/delete?guid={$params['group']->guid}"),
							'class' => 'button-grey',
							'id' => 'delete-cover-group',
							'action' => true,
						));
						?>
